...
> **Fokus aktif**: translasi EN → ID untuk FFT WoTL. Lihat `TODO_PLAN.md`
> (roadmap berfase) dan `CLAUDE.md` (catatan arsitektur & temuan reverse
> engineering). Riset komunitas + temuan internal ada di `DocumentOfComunity.md`.
